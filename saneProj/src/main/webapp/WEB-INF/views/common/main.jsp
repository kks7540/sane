...
<!-- page script -->
<script type="text/javascript" src="${custom_js_path}/common/topMenu.js"></script>
...
<!-- ==========================================  	   ==========================================-->
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.html">Sane Company</a>
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" id="btn_logout" style="cursor:pointer;">Logout</a>
                    </div>
                </li>
            </ul>
        </nav>
