...
$(function() {
    ...
    require(
        [
        	/*ctx+'/resources/assets/js/plugins/visualization/echarts/echarts',
        	ctx+'/resources/assets/js/plugins/visualization/echarts/theme/limitless',
        	ctx+'/resources/assets/js/plugins/visualization/echarts/chart/bar',
        	ctx+'/resources/assets/js/plugins/visualization/echarts/chart/line'*/
        	'echarts',
